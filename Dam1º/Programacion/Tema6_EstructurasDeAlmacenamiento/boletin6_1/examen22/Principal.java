...
public class Principal {
    ...
    private static final Jugador modric = new Jugador(1, "Modric", REAL_MADRID, 170);
    private static final Jugador benzema = new Jugador(2, "Benzema", REAL_MADRID, 181);
    private static final Jugador curtois = new Jugador(3, "Curtois", REAL_MADRID, 196);
    private static final Jugador joaquin = new Jugador(4, "Joaquin", REAL_BETIS, 175);
    private static final Jugador canales = new Jugador(5, "Canales", REAL_BETIS, 180);
    private static final Jugador fekir = new Jugador(6, "Fekir", REAL_BETIS, 170);
    private static final Jugador panda = new Jugador(7, "Borja Iglesias", REAL_BETIS, 189);
    private static final Jugador dembele = new Jugador(8, "Dembele", BARCELONA, 176);
    private static final Jugador busquets = new Jugador(9, "Busquets", BARCELONA, 187);
    private static final Jugador gabi = new Jugador(10, "Gabi", BARCELONA, 172);

    private static final Escudo realMadrid = new Escudo(11, REAL_MADRID, 1895, 4);
    private static final Escudo realBetis = new Escudo(12, REAL_BETIS, 1897, 4);
    private static final Escudo barcelona = new Escudo(13, BARCELONA, 1896, 6);

    private static final ArrayList<Cromo> todos = new ArrayList<>(
